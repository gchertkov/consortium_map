document.addEventListener('DOMContentLoaded', function () {
    ...
    function populateStakeholderPage(stakeholder, data) {
        ...
        main.innerHTML = `<h1>${stakeholder.Name}</h1><a href='${stakeholder.Link}' target='_blank'>Link to organization site</a><br><br>`;
        ...
        // Display links to other secondary stakeholders, sorted alphabetically by their names
        ...
        if (secondaryStakeholders.length > 0) {
            secondaryStakeholders.sort((a, b) => a.Name.localeCompare(b.Name)); // Sorting alphabetically by name
